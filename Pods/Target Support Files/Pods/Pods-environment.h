...
#define COCOAPODS_POD_AVAILABLE_CocoaLumberjack_Swift
#define COCOAPODS_VERSION_MAJOR_CocoaLumberjack_Swift 2
#define COCOAPODS_VERSION_MINOR_CocoaLumberjack_Swift 0
#define COCOAPODS_VERSION_PATCH_CocoaLumberjack_Swift 1
